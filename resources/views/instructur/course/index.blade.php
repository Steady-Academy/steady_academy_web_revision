...
@section('content')
	<div class="container-fluid p-0">
		<div class="d-flex align-items-center justify-content-between">
			...
			<a href="{{ route('instructur.add.course') }}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <div class="col-12 col-sm-3">
                        <div class="card border border-1 shadow shadow-sm" style="border-radius: 25px">
                            ...
                            <div class="card-body py-2">
                                <a href="{{ route('instructur.show.course', $course->data()['id']) }}" class="card-title fs-h5 mb-1 fw-bold text-truncate text-decoration-none stretched-link"
