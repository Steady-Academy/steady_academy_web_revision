		...
		<div class="row justify-content-center">
			<div class="col-10">
				<div class="card">
					...
					<div class="card-body">
						<form id="edit" class="form" runat="server" action="{{ route('admin.student.update', $student['uid']) }}"
							method="POST" enctype="multipart/form-data">
							<input type="hidden" name="_method" value="PUT">
							<input type="hidden" name="uid" value="{{ $student['uid'] }}">
							<input type="hidden" name="oldPicture" value="{{ $student['photoUrl'] }}">
							@csrf
							@method('PUT')
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<input type="text" class="form-control @error('nama') is-invalid @enderror" id="formGroupExampleInput"
											name="nama" value="{{ $student['name'] }}" placeholder="Input student nama" required>
										@error('nama')
											<div class="invalid-feedback">
												{{ $message }}
											</div>
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<input type="tel" class="form-control @error('telepon') is-invalid @enderror" id="formGroupExampleInput"
											value="{{ $student['phoneNumber'] }}" name="telepon" placeholder="+62" required>
										@error('telepon')
											<div class="invalid-feedback">
												{{ $message }}
											</div>
							...
							<div class="mb-3">
								...
								<input type="email" class="form-control @error('email') is-invalid @enderror" id="formGroupExampleInput"
									name="email" value="{{ $student['email'] }}" placeholder="Input student email" required>
								@error('email')
									<div class="invalid-feedback">
										{{ $message }}
									</div>
								...
								<div class="col-12 col-sm-6 col-xx-6">
									<div class="mb-3">
										...
										<input type="password" class="form-control @error('password_baru') is-invalid @enderror" id="password"
											name="password_baru" placeholder="Input student password" required>
										@error('password')
											<div class="invalid-feedback">
												{{ $message }}
											</div>
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<select class="form-control @error('konfirmasi') is-invalid @enderror" id="konfirmasi" name="konfirmasi">
											...
											<option value="true" {{ $student['is_confirmed'] == true ? 'selected' : 'is_invalid' }}>true</option>
											<option value="false" {{ $student['is_confirmed'] == false ? 'selected' : 'is_invalid' }}>false</option>
										</select>
										@error('konfirmasi')
											<div class="invalid-feedback">
												{{ $message }}
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<select class="form-control @error('terdaftar') is-invalid @enderror" id="terdaftar" name="terdaftar">
											<option value="">Pilih</option>
											<option value="true" {{ $student['registered'] == true ? 'selected' : 'is_invalid' }}>true</option>
											<option value="false" {{ $student['registered'] == false ? 'selected' : 'is_invalid' }}>false</option>
										</select>
										@error('terdaftar')
											<div class="invalid-feedback">
												{{ $message }}
	...
	<script>
		function confirmEdit() {
			...
			swalWithBootstrapButtons.fire({
				...
				text: "Jika kamu mengubah data, student akan mengetahui.",
				icon: 'warning',
