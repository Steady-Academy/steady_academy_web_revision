...
@section('title', 'Edit Data Instructur | Basicschool')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Edit Data Instructur</h1>
			...
			<div class="col-10">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Edit Instructur</h5>
					...
					<div class="card-body">
						<form id="edit" class="form" runat="server"
							action="{{ route('admin.instructur.update', $instructur['uid']) }}" method="POST" enctype="multipart/form-data">
							<input type="hidden" name="_method" value="PUT">
							<input type="hidden" name="uid" value="{{ $instructur['uid'] }}">
							<input type="hidden" name="oldPicture" value="{{ $instructur['photoUrl'] }}">
							@csrf
							@method('PUT')
							<div class="hstack justify-content-center">
								<div class="mb-3 text-center">
									<img src="{{ $instructur['photoUrl'] }}" alt="{{ $instructur['name'] }}"
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<input type="text" class="form-control @error('nama') is-invalid @enderror" id="formGroupExampleInput"
											name="nama" value="{{ $instructur['name'] }}" placeholder="Input instructur nama" required>
										@error('nama')
											<div class="invalid-feedback">
												{{ $message }}
											</div>
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<input type="tel" class="form-control @error('telepon') is-invalid @enderror" id="formGroupExampleInput"
											value="{{ $instructur['phoneNumber'] }}" name="telepon" placeholder="+62" required>
										@error('telepon')
											<div class="invalid-feedback">
												{{ $message }}
											</div>
							...
							<div class="mb-3">
								...
								<input type="email" class="form-control @error('email') is-invalid @enderror" id="formGroupExampleInput"
									name="email" value="{{ $instructur['email'] }}" placeholder="Input instructur email" required>
								@error('email')
									<div class="invalid-feedback">
										{{ $message }}
									</div>
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<select class="form-control @error('konfirmasi') is-invalid @enderror" id="konfirmasi" name="konfirmasi">
											...
											<option value="true" {{ $instructur['is_confirmed'] == true ? 'selected' : 'is_invalid' }}>true</option>
											<option value="false" {{ $instructur['is_confirmed'] == false ? 'selected' : 'is_invalid' }}>false</option>
										</select>
										@error('konfirmasi')
											<div class="invalid-feedback">
												{{ $message }}
								...
								<div class="col-12 col-sm-6 col-xxl-6">
									<div class="mb-3">
										...
										<select class="form-control @error('terdaftar') is-invalid @enderror" id="terdaftar" name="terdaftar">
											<option value="">Pilih</option>
											<option value="true" {{ $instructur['registered'] == true ? 'selected' : 'is_invalid' }}>true</option>
											<option value="false" {{ $instructur['registered'] == false ? 'selected' : 'is_invalid' }}>false</option>
										</select>
										@error('terdaftar')
											<div class="invalid-feedback">
												{{ $message }}
