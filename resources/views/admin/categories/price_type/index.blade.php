...
@section('title', 'Data Tipe Harga | Steady Academy')
@push('custom-style')
	<style>
...
@section('content')
	<div class="container-fluid p-0">
		<h1 class="mb-3">Data Tipe Harga</h1>
		<nav style="--bs-breadcrumb-divider: '/';" aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Dashboard</a></li>
				<li class="breadcrumb-item active" aria-current="page">Kategori</li>
				<li class="breadcrumb-item active" aria-current="page">Kategori Tipe Harga</li>
			</ol>
		</nav>
					...
					<div class="card-body">
						...
						<div id="content" class="d-none">
							<div id="add" class="add align-items-center text-lg-start text-center my-2">
								...
								<a href="{{ route('admin.tipe_harga.create') }}" class="btn btn-success mb-2"><svg
										xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
										stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
										class="feather feather-plus">
										<line x1="12" y1="5" x2="12" y2="19" />
										<line x1="5" y1="12" x2="19" y2="12" />
									</svg> Tambah Tipe Harga </a>
							</div>
...
@push('custom-script')
	...
	<script src="{{ env('URL_NGROK') }}/assets-admin/js/page/dataTablePriceType.js"></script>
