...
@section('title', 'Edit Kategori | Steady Academy')
@section('content')
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Edit Kategori Kursus</h1>
			...
			<div class="col-7">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Edit Kategori Kursus</h5>
					...
					<div class="card-body">
						<form class="form" runat="server" action="{{ route('admin.kursus_kategori.update', $category_course['id']) }}"
							method="POST" enctype="multipart/form-data" id="update">
							<input type="hidden" name="_method" value="PUT">
							<input type="hidden" name="uid" value="{{ $category_course['id'] }}">
							<input type="hidden" name="oldPhoto" value="{{ $category_course['photoUrl'] }}">
							@csrf
							@method('PUT')
							<div class="row justify-content-center">
								<div class="col-10">
									<div class="mb-3 text-center">
										<img src="{{ $category_course['photoUrl'] }}" alt="{{ $category_course['name'] }}"
											class="rounded-3 border border-2 border-dark bg-secondary" width="100" height="100" id="photo">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control @error('nama_kategori') is-invalid @enderror"
											id="formGroupExampleInput" name="nama_kategori" value="{{ $category_course['name'] }}"
									...
									<div class="mb-3">
										...
										<textarea name="deskripsi_kategori" id="deskripsi_kategori" cols="10" rows="5" class="form-control"
										 placeholder="Masukan Deskripsi Kategori" required>{{ $category_course['description'] }}</textarea>
